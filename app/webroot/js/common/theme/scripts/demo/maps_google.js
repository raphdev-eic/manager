...
function initScripts()
{
	...
	var $scripts = [
        commonPath + "theme/scripts/plugins/maps/jquery-ui-map/ui/jquery.ui.map.js",
        commonPath + "theme/scripts/plugins/maps/jquery-ui-map/ui/jquery.ui.map.extensions.js",
        commonPath + "theme/scripts/plugins/maps/jquery-ui-map/ui/jquery.ui.map.services.js",
        commonPath + "theme/scripts/plugins/maps/jquery-ui-map/ui/jquery.ui.map.microformat.js",
        commonPath + "theme/scripts/plugins/maps/jquery-ui-map/addons/markerclustererplus/markerclusterer.min.js"
    ];
...
function initGoogleMaps()
{
	...
	if ($('#google-map-json').length)
	{
		$('#google-map-json').gmap().bind('init', function() { 
			$.getJSON( commonPath + 'theme/scripts/plugins/maps/jquery-ui-map/data/demo.json', function(data) { 
