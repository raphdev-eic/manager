...
$(function()
{
	...
	{
		$.getJSON( commonPath + 'theme/scripts/plugins/maps/jvectormap/data/us-unemployment.json', function(data){
			var val = 2009;
	...
	{
		$.getJSON(commonPath + 'theme/scripts/plugins/maps/jvectormap/data/france-elections.json', function(data){
			new jvm.WorldMap({
				map: 'fr_merc_en',
