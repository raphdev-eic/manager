...
<div class="heading-buttons">
	<h1>Domaines EiC <span>Edit domaines</span></h1>
	<div class="buttons pull-right">
		<a href="<?php echo $this->Html->url(array('controller' => 'Domaines', 'action' => 'DomaineList')); ?>" class="btn btn-default btn-icon glyphicons left_arrow"><i></i> return to List</a>
	</div>
...
<?php $this->end(); ?>
<div class="innerLR">
	<?php echo $this->Form->create('Domaine'); ?>
				...
				<div class="tab-pane active" id="productDescriptionTab">
					...
					<div class="row-fluid">
						...
						<div class="span3">
							...
							<p class="muted">Ajouter le nom du domaine (son sigle).</p>
						</div>
						<!-- // Column END -->
						...
						<div class="span9">
							...
							<?php echo $this->Form->input('name',array('id'=>'inputTitle','class'=>'span6','placeholder'=>'Entrer le nom du Domaine...','label'=>false)); ?>
